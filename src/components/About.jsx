...
function About() {
    return (
        <div className="About">
            ...
            I moved to Utah to follow my passion for computer
            programming. I studied at the Web Design Bootcamp DevMountain to sharpen my skills. It was a phenominal experience which allowed me to gain the skills I need to comfortably design and build websites from scratch. </p></div>
            </div>
            <Gallery/>
        </div>
    )
